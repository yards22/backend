...
export class LikeNotification extends BaseNotification {
    ...
    ToJson(): string {
        return JSON.stringify({ post_id: this.post_id, type: this.type, by: this.by })
    }
}
...
export type NotificationMetadataType = LikeNotification | CommentNotification | FollowNotification;