...
var NotificationManager = /** @class */ (function () {
    ...
    NotificationManager.prototype.Create = function (forId, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.store.notifications.create({
    ...
    NotificationManager.prototype.GetByID = function (id) {
        return this.store.notifications.findUnique({ where: { id: id } });
    };
    // Returns notification by notification_id and for_id
    NotificationManager.prototype.GetByIDAndForID = function (forId, id) {
        return this.store.notifications.findFirst({
            where: { AND: [{ for_id: forId, id: id }] },
        });
    };
    // Returns notifications for a user
    NotificationManager.prototype.GetManyByForID = function (forId, status, limit, offset) {
    ...
    NotificationManager.prototype.UpdateStatus = function (forId, ids, status) {
        return __awaiter(this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.store.notifications.updateMany({
